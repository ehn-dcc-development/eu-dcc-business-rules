...
describe("JavaScript Date", () => {
    ...
    it("construct datetimes in RFC 3339 format (compliant with a JSON Schema \"date-time\" formatted string)", () => {
    ...
    it("try to construct datetimes in non-RFC 3339 but ISO 8601 formats", () => {
