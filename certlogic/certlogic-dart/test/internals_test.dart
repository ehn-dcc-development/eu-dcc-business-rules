...
void main() {
  ...
  group('parsing of dates/date-times', () {
    void check(String dateTimeLike, String expected, [String? message]) {
      expect(CertLogicInternals.dateFromString(dateTimeLike).toUtc(), DateTime.parse(expected).toUtc(), reason: message);
    }

    test('construct a date from a string without time information (compliant with a JSON Schema \'date\' formatted string)', () {
      check('2021-05-04', '2021-05-04T00:00:00.000Z');
      check('2021-05-04', '2021-05-04T00:00:00.000Z');
    });

    test('construct date-times from strings in RFC 3339 format (compliant with a JSON Schema \'date-time\' formatted string)', () {
    ...
    test('construct date-times from strings in non-RFC 3339 but ISO 8601 formats', () {
    ...
    test('construct date-times from strings which have a \'short\' timezone offset', () {
  ...
  group('plusTime', () {
    void check(String dateTimeLike, int amount, CertLogicTimeUnit unit, String expected) {
      expect(CertLogicInternals.plusTime(dateTimeLike, amount, unit).toUtc(), DateTime.parse(expected).toUtc());
    }

    test('works for 1-day offsets', () {
      check('2021-06-23', 1, CertLogicTimeUnit.DAY, '2021-06-24T00:00:00.000Z');
      check('2021-06-23', -1, CertLogicTimeUnit.DAY, '2021-06-22T00:00:00.000Z');
    });

    test('works for 1-hour offsets', () {
      check('2021-06-23T00:00:00.000Z', 1, CertLogicTimeUnit.HOUR, '2021-06-23T01:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', -1, CertLogicTimeUnit.HOUR, '2021-06-22T23:00:00.000Z');
    });

    test('works for day-offsets in hours', () {
      check('2021-06-23T00:00:00.000Z', 24, CertLogicTimeUnit.HOUR, '2021-06-24T00:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', 48, CertLogicTimeUnit.HOUR, '2021-06-25T00:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', 72, CertLogicTimeUnit.HOUR, '2021-06-26T00:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', -24, CertLogicTimeUnit.HOUR, '2021-06-22T00:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', -48, CertLogicTimeUnit.HOUR, '2021-06-21T00:00:00.000Z');
      check('2021-06-23T00:00:00.000Z', -72, CertLogicTimeUnit.HOUR, '2021-06-20T00:00:00.000Z');
    });

    test('not affected by DST transitions', () {
      check('2021-06-23', -180, CertLogicTimeUnit.DAY, '2020-12-25T00:00:00.000Z');
    });
    ...
    test('yields comparable values', () {
      expect(
        CertLogicInternals.plusTime('2020-12-24', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', -180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        false,
      ); // 'd1 more than 180 days before d2'
      expect(
        CertLogicInternals.plusTime('2020-12-24', 180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        false,
      ); // 'd1 more than 180 days before d2'
      expect(
        CertLogicInternals.plusTime('2020-12-25', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', -180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        true,
      ); // 'd1 exactly 180 days before d2'
      expect(
        CertLogicInternals.plusTime('2020-12-25', 180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        true,
      ); // 'd1 exactly 180 days before d2'
      expect(
        CertLogicInternals.plusTime('2020-12-26', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', -180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        true,
      ); // 'd1 less than 180 days before d2'
      expect(
        CertLogicInternals.plusTime('2020-12-26', 180, CertLogicTimeUnit.DAY).millisecondsSinceEpoch >=
            CertLogicInternals.plusTime('2021-06-23T00:00:00Z', 0, CertLogicTimeUnit.DAY).millisecondsSinceEpoch,
        true,
      ); // 'd1 less than 180 days before d2'
    });
    ...
    test('works for month offsets', () {
      check('2021-02-01T00:00:00.000Z', 0, CertLogicTimeUnit.MONTH, '2021-02-01T00:00:00.000Z');
      check('2021-02-01T00:00:00.000Z', 1, CertLogicTimeUnit.MONTH, '2021-03-01T00:00:00.000Z');
      check('2021-12-01T00:00:00.000Z', 1, CertLogicTimeUnit.MONTH, '2022-01-01T00:00:00.000Z');
      check('2021-12-01T00:00:00.000Z', -12, CertLogicTimeUnit.MONTH, '2020-12-01T00:00:00.000Z');
      check('2020-02-29T00:00:00.000Z', 1, CertLogicTimeUnit.MONTH, '2020-03-29T00:00:00.000Z');
    });

    test('works for year offsets', () {
      check('2021-02-01T00:00:00.000Z', 0, CertLogicTimeUnit.YEAR, '2021-02-01T00:00:00.000Z');
      check('2021-02-01T00:00:00.000Z', 1, CertLogicTimeUnit.YEAR, '2022-02-01T00:00:00.000Z');
      check('2021-02-01T00:00:00.000Z', -1, CertLogicTimeUnit.YEAR, '2020-02-01T00:00:00.000Z');
      check('2021-02-01T00:00:00.000Z', 2, CertLogicTimeUnit.YEAR, '2023-02-01T00:00:00.000Z');
      check('2020-02-29T00:00:00.000Z', 1, CertLogicTimeUnit.YEAR, '2021-02-28T00:00:00.000Z');
    });
  });
  ...
  group('extractFromUVCI', () {
    ...
    test('foo/bar::baz#999lizards (without optional prefix)', () {
      ...
      expect(CertLogicInternals.extractFromUVCI(uvci, 2), ''); // not null, but still falsy
